...
namespace v2_1
{
    public class ISBE2GlobalEvent2Test : IBroadcastEventEx
    {
        enum EventCmd
        {
            Init,
        ...
        private ISBE2GlobalEvent2 m_ge2;
                    ...
                    case EventCmd.Event:
                        ...
                        if (ep.EventID == SBEEvent.StreamDescEvent)
                        {
                            if (!m_bWorked)
                            {
                                ...
                                hr = m_ge2.GetEventEx(ep.EventID, ep.Param1, ep.Param2, ep.Param3, ep.Param4, out sp, ref i, ip, out ll);
                                Thread.Sleep(1);
