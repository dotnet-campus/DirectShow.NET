...
// This the test for the "old" version of IComponents (aka IComponentsOld)

namespace DirectShowLib.Test
{
  public class IComponentsOldTest
  {
    private IComponents m_comps;

    public IComponentsOldTest()
    {
    }
