...
namespace DirectShowLib.Sample
{
    ...
    private void InitializeDirect3D()
    {
      ...
      // Add MultiThreaded to be safe. Each DirectShow filters run in a separate thread...
      device = new Device(
        0, 
        DeviceType.Hardware, 
        this, 
    ...
    private void BuildGraph(string fileName)
    {
      ...
      {
        CloseInterfaces();
        MessageBox.Show("An error occure during the graph building : \r\n\r\n" + e.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
      }
    }
    ...
    private void SetMixerSettings()
    {
      ...
      if (!mixerEnabled) // Did the use disable the bitmap ?
      {
